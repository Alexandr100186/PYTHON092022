...
# имя 
def input_firstname(): 
    first = input("Введите имя контакта: ") 
    remfname = first[1:] 
    firstchar = first[0] 
...
# фамилия 
def input_lastname(): 
    last = input("Введите фамилию контакта: ") 
    remlname = last[1:] 
    firstchar = last[0] 
...
def newcontact(): 
    ...
    phoneNum = input("Введите номер телефона контакта: ") 
    emailID = input("Введите E-mail контакта: ") 
